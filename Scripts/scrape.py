...
def analyze_text_with_gemini(text_chunk: str) -> list:
    ...
    """
    # API Key is removed for security. It will be handled by the environment.
...
if __name__ == "__main__":
    input_file = "../Data/scraped_text.txt"
    output_file = "../Data/analysis_results.json"

    if not os.path.exists(input_file):
        print(f"Error: Input file '{input_file}' not found. Run app.py first.")
    else:
